...
namespace System.Data.Hsql.Linq
{
	...
	/// </summary>
	internal class SharpHsqlProviderManifest : DbXmlEnabledProviderManifest
	{
		internal SharpHsqlDateFormats _dateFormat;
		...
		protected override XmlReader GetDbInformation(string informationType)
		{
			...
			throw new ProviderIncompatibleException(String.Format("SharpHsql does not support this information type '{0}'.", informationType));
		}
		...
		public override TypeUsage GetEdmType(TypeUsage storeType)
		{
			...
			//    default:
			//      throw new ArgumentException(String.Format("SharpHsql does not support the type '{0}'.", storeTypeName));
			//  }
			//}
			...
			default:
				throw new NotSupportedException(String.Format("SharpHsql does not support the type '{0}'.", storeTypeName));
			}
		...
		public override TypeUsage GetStoreType(TypeUsage edmType)
		{
			...
			if (primitiveType == null)
				throw new ArgumentException(String.Format("SharpHsql does not support the type '{0}'.", edmType));
