namespace System.Data.Hsql.Linq
{
	...
	{
		private SharpHsqlProviderManifest _manifest;
		...
		/// Basic constructor. 
		/// </summary>
		private SqlGenerator(SharpHsqlProviderManifest manifest)
		{
			_manifest = manifest;
		}
		#endregion
		...
		internal static string GenerateSql(SharpHsqlProviderManifest manifest, DbCommandTree tree, out List<DbParameter> parameters, out CommandType commandType)
		{
		...
		private static ISqlFragment HandleGetDateFunction(SqlGenerator sqlgen, DbFunctionExpression e)
		{
			...
			{
			case SharpHsqlDateFormats.Ticks:
				result.Append("(STRFTIME('%s', 'now') * 10000000 + 621355968000000000)");
				break;
			case SharpHsqlDateFormats.JulianDay:
